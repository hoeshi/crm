...
import ch.zli.hoeshi.crm.exception.UserAlreadyExistsException;
import ch.zli.hoeshi.crm.exception.UserNotFoundException;
...
public class UserServiceImpl implements UserService {
	...
	public AppUser addUser(String userName, String password, List<String> roles) {
		...
		return userRepository.insertUser(
				userName, password, roles == null ? new ArrayList<>() : roles, password, password);
	}
